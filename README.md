...
본 프로젝트는 2 인이 함께 수행한 프로젝트로 구조 설계부터 구현, 테스트까지 작성한 모든 내용에 대해 서로 의논하며 프로그램을 작성하였습니다. [@duckbok](https://github.com/duckbok)
...
# 6. 주간 동료 평가
- Week 1 (7. 19. ~ 7. 25.)
  + 덕복 → Ryan: 라이언은 정말 부지런하고 집중력이 엄청나서 저도 본받아 한 주간 조금이나마 그렇게 살 수 있었어요 ㅎ_ㅎ
  + Ryan → 덕복: 당신이 없었다면.. 이번 주 탈주했을거에요.. 고마워요 덕복 용사 ☺️  당신은 나의 Heisenberg..!

- Week 2 (7. 26. ~ 8. 1.)
  + 덕복 → Ryan: 라이언은 창의적으로 생각을 하여 항상 새로운 길~~(낭떠러지)~~을 제시해주는 좋은 프로그래머입니다ㅎㅎ 그리고 ~~쓸데없이~~ 부지런하여 항상 저를 ~~굳이~~ 바른 길로 이끌어주셔서 감사한 한 주 였어요 :D
  + Ryan → 덕복: 이젠 덕복 없인 구현도 디버깅도 할 수 없는 몸이 되어버렷..! 덕복은 작은 것도 잘 칭찬해주고 사람을 후하게 봐주어서 굉장히 동기부여가 많이 되었어요. 고마워요~! 😊

- Week 3 (8. 2. ~ 8. 8.)
  + 덕복 → Ryan: Ryan은 좋은 아이디어를 많이 내주셔서 프로젝트를 부드럽게 진행할 수 있었어요!! 게으른 저를 데리고 3주간 잘 진행해주셔서 감사했습니다 :D
  + Ryan → 덕복: 다시 만나도 같이 일하고 싶은 개발자, 덕복 ❤️
